    ...
    <main>
      ...
      >
        <div className="flex flex-col w-full lg:w-1/2">
          <h2 className="text-4xl md:text-7xl 2xl:text-8xl">Services</h2>
        </div>

        <div className="flex flex-col w-full lg:w-1/2">
          <ServicesDrawer
            service="Construction"
            description="We focus on adaptive reuse, flex warehouse, and full multi-family construction from land acquisition to occupancy. We currently have over 500 multifamily units planned for the next three years."
          />
          <ServicesDrawer
            service="Investment"
      ...
      <section className="flex flex-col gap-6 lg:gap-10 lg:flex-row h-fit text-clutchBlue-900 px-5 lg:px-10 py-10 lg:py-20">
        ...
        <div className="flex flex-col gap-6 w-full lg:w-1/2">
          ...
          <div className="flex flex-col gap-6">
            <p className="text-gray-500">
              ...
              pellentesque habitant morbi tristique. Amet cursus sit amet dictum
      ...
      >
        ...
        <div className="flex flex-col gap-5 lg:flex-row justify-between w-full">
          <div className="w-full lg:w-1/3 bg-gray-200 h-[400px]">Completed</div>
