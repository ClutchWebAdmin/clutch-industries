  ...
  if (variant === "light" && purpose === "link") {
    return (
      <section className={`px-5 lg:px-10 py-20 text-clutchBlue-900 bg-white`}>
        <div
          className="flex flex-col gap-6 justify-center items-center xl:max-w-screen-xl 2xl:max-w-screen-2xl mx-auto"
          data-aos="fade-up"
    ...
    return (
      <section
        className={`px-5 lg:px-10 py-20 text-white bg-clutchBlue-700 justify-center items-center`}
      >
        <div
          className="flex flex-col gap-6 justify-center items-center xl:max-w-screen-xl 2xl:max-w-screen-2xl mx-auto"
          data-aos="fade-up"
