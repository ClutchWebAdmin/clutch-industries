...
export default function ProjectsPage() {
  return (
    <main>
      <div className="flex flex-col gap-10 lg:gap-16 w-full h-full px-5 lg:px-10 py-10 lg:py-20 xl:w-[1280px] xl:max-w-screen-xl 2xl:w-[1536px] 2xl:max-w-screen-2xl mx-auto">
